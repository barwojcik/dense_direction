...
class DPTDirectionHead(BaseDirectionDecodeHead):
    ...
    def layers(self, inputs: list[Tensor]) -> Tensor:
        ...
        feature_list: list[Tensor] = self._transform_inputs(inputs)  # type: ignore[assignment]
