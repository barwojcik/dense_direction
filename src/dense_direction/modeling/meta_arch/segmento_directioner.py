...
class SegmentoDirectioner(Directioner):
    ...
    def postprocess_seg_result(
        ...
        for seg_logit, data_sample in zip(seg_logits, data_samples, strict=False):
    ...
    def postprocess_result(
        self,
        results: tuple[Tensor, Tensor],  # type: ignore[override]
    ...
    def aug_test(
        self, inputs: Tensor, batch_img_metas: list[dict], rescale: bool = True
    ) -> tuple[Tensor, Tensor]:
