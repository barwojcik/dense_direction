...
def radial_line_kernel(
    ...
    **kwargs: Any,
    ...
    """
    This function computes the radial line kernel.

    Returns a tensor that contains the radial line kernel for directional loss computation.
    Each channel represents a line that is the diameter of the circle.
...
def polar_wedge_kernel(
    ...
    **kwargs: Any,
    ...
    """
    This function computes the polar wedge kernel.
    ...
    Args:
        ...
        threshold (float, optional): The angular distance threshold for wedges in radians.
            It Should be in the range from 0 to 0.25π. Default: 0.1π.
...
def polar_disc_kernel(
    ...
    **kwargs: Any,
    ...
    """
    This function computes the polar disc kernel.
    ...
    Args:
        ...
        div (int): Division factor for direction bins. Default: 20.
        alpha (float, optional): The exponent parameter for the polar kernel. Default: 1.0.
        radius (float | None): Radius parameter for a disc mask.
...
def polar_sector_kernel(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        radius (float, optional): Radius parameter for a disc mask.
